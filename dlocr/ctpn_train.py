...
if __name__ == '__main__':
    ...
    parser.add_argument("--images_dir", help="图像位置", default="E:\python-project\ocr-data\VOCdevkit\VOC2007\JPEGImages")
    parser.add_argument("--anno_dir", help="标注文件位置", default="E:\python-project\ocr-data\VOCdevkit\VOC2007\Annotations")

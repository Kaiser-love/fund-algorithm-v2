...
if __name__ == '__main__':
    ...
    parser.add_argument("--dict_file_path", help="字典文件位置",
                        default="E:\python-project\ocr-data\DataSet\char_std_5990.txt")
    parser.add_argument("--train_file_path", help="训练文件位置",
                        default="E:\python-project\ocr-data\DataSet\data_train.txt")
    parser.add_argument("--test_file_path", help="测试文件位置",
                        default="E:\python-project\ocr-data\DataSet\data_test.txt")
    ...
    # 如果是在训练CTPN那么数字是字符的bbox信息，如果在训练识别那么就是在字典里的索引，那么就需要字符和字典的文字对应。
